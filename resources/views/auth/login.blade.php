...
@section('title', 'Login all utilisateur here')
@section('content')
                        ...
                        <div class="signup-block">
                            <form method="POST" class="signup-form" action="{{ route('login') }}">
                                ...
                                <div class="row">
                                    ...
                                    {{--<div class="col-lg-6 col-md-6 col-6">
                                        <div class="forgot-password text-right btm-20"><a href="{{ 'password/reset' }}" title="sign-up">{{ __('frontstaticword.ForgotPassword') }}</a>
                                        </div>
                                    </div>--}}
                                </div>
                                <div class="form-group">
