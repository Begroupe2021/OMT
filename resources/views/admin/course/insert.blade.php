        ...
        <div class="card-body">
           ...
           {{-- <div class="row">
            ...
            <br>
             ...
             {{-- <div class="col-md-3">
                ...
                <input  name="involvement_request" type="checkbox" class="custom_toggle"   id="involve"  unchecked />
            ...
            <div class="row">
              {{--<div class="col-md-6">
                ...
                <div id="document2">
                  ...
                  <input type="url" name="url" id="url"  placeholder="{{ __('adminstaticword.Enter') }} {{ __('adminstaticword.URL') }}" class="form-control" value="{{ (old('url')) }}">
                </div>
              </div>--}}
            ...
            <div class="row">
              ...
              <div class="col-md-6 " style="visibility: hidden;">
                ...
                <div class="input-group">
                  <input min="0" max="100" class="form-control"name="instructor_revenue" type="number" id="revenue"  placeholder="{{ __('adminstaticword.Enter') }} revenue percentage" class="{{ $errors->has('instructor_revenue') ? ' is-invalid' : '' }} form-control" value="0">
          ...
          <div class="row">
           {{-- <div class="col-sm-3 none">
                ...
                <input   id="frees" type="checkbox" class="custom_toggle" name="assignment_enable"  />
              ...
              <div class="col-sm-3 none">
                ...
                <input   id="frees1" type="checkbox" class="custom_toggle" name="appointment_enable"  />
