            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div @if($cate->preview_type =="url" ) class="display-none" @endif id="document11">
                  <label for="exampleInputSlug">{{ __('Preview') }} {{ __('adminstaticword.UploadVideo') }}: <sup class="redstar">*</sup></label>
                   <!-- =========== -->
                   <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupFileAddon01">{{ __('Upload') }}</span>
                ...
                <div @if($cate->preview_type =="video") class="display-none" @endif id="document22">
                  ...
                  <label for="exampleInputSlug">{{ __('Preview') }} {{ __('adminstaticword.URL') }}: <sup class="redstar">*</sup></label>
