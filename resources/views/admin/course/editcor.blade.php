            ...
            <!-- country end -->
              ...
              <div class="row">
                ...
                <div class="col-md-3 d-none" >
                  ...
                  <div style="{{ $cor->type == 1 ? '' : 'display:none' }}" class="d-none" id="doabox">
                    <label for="exampleInputSlug">{{ __('adminstaticword.Price') }}: <sup class="redstar">*</sup></label>
                    <input step="0.01" type="text" inputmode="numeric" pattern="[-+]?[0-9]*[.,]?[0-9]+"  class="form-control" name="price" id="priceMain" placeholder="{{ __('adminstaticword.Enter') }} {{ __('adminstaticword.Price') }}" value="{{ $cor->price }}">
                ...
                <div class="col-md-3 d-none">
                  ...
                  <label class="switch">
                    <input class="slider" type="checkbox" id="customSwitch6" name="featured"  />
                    <span class="knob"></span>
                  </label>
                ...
                <div class="col-md-4">
                  ...
                  <label class="switch">
                    <input class="slider" type="checkbox" id="customSwitch6" name="involvement_request" />
                    <span class="knob"></span>
                  </label>
              ...
              <br>
                ...
                {{--<div class="col-md-4">
                  ...
                  <div style="{{ $cor->preview_type == 'url' ? 'display:none' : '' }}" id="document1" class="d-none">
                    <br>
                  ...
                  <div @if($cor->preview_type =="video") class="display-none d-none" @endif id="document2">
                    <br>
                    <label for="exampleInputSlug">{{ __('adminstaticword.URL') }}: <sup class="redstar">*</sup></label>
                    <input type="url"  class="form-control" placeholder="{{ __('adminstaticword.Enter') }} URL" name="url" id="url" value="{{ $cor->url }}">
                  </div>
                </div>--}}
              ...
              <div class="row">
                ...
                <div class="col-md-6 d-none">
                  ...
                  <div class="input-group">
                    ...
                    <input min="0" max="100" class="form-control" name="instructor_revenue" type="number" value="{{ $cor['instructor_revenue'] }}" id="revenue"  placeholder="Enter revenue percentage" class="{{ $errors->has('instructor_revenue') ? ' is-invalid' : '' }} form-control">
              ...
              <div class="col-sm-3 d-none">
                  ...
                  <label class="switch">
                    <input class="slider" type="checkbox" name="assignment_enable" />
                    <span class="knob"></span>
                  </label>
                  <br>
                 ...
                 <div class="col-sm-3 d-none">
                  ...
                  <label class="switch">
                    <input class="slider" type="checkbox" name="appointment_enable" />
                    <span class="knob"></span>
                  </label>
                ...
                <div class="col-sm-3 d-none">
                  ...
                  <label class="switch">
                    <input class="slider" type="checkbox" name="drip_enable" />
                    <span class="knob"></span>
                  </label>
                  <br>
