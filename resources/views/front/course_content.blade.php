                                                    ...
                                                    <td>
                                                        ...
                                                        <span>{{ __('Title') }}:{{ $assign->title }}</span>
                                                         ...
                                                         <div class="col-lg-6 col-md-6">
                                                            ...
                                                            <a href="{{ asset('files/assignment/'.$assign->assignment) }}" download="{{$assign->assignment}}" title="{{ __('Download')}}"> <i class="fa fa-download"></i></a>

                                                            
                                                            <form  method="post" action="{{url('assignment/delete/'.$assign->id)}}" ata-parsley-validate class="form-horizontal form-label-left">
                                                            {{ csrf_field() }}

                                                                <button  type="submit" class="assign-remove-btn display-inline" title="{{ __('Delete')}}"> <i class="fas fa-trash-alt"></i></button>
                                                              </form>
                                                            </div>
                                                        </div>
                                                    </div>
