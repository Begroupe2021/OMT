                                    ...
                                    <ul>
                                        <li>
                                            <div class="form-check form-check-inline">
                                                ...
                                                <label class="form-check-label active" for="inlineCheckboxpaid">{{ __('frontstaticword.Paid') }}</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check form-check-inline">
                                                ...
                                                <label class="form-check-label" for="inlineCheckboxfree">{{ __('frontstaticword.Free') }}</label>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="rate text-right">
                                            ...
                                            <div class="rating">
                                                ...
                                                <li>
                                                    ...
                                                    @else
                                                        <div class="pull-left"><p>{{ __('No Rating') }}</p></div>
                                                    @endif
                                                </li>
